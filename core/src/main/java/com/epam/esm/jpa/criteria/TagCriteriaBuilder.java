...
public class TagCriteriaBuilder {
    public CriteriaQuery<TagEntity> build(CriteriaBuilder criteriaBuilder, String tagNamePrefix) {
        ...
        if (tagNamePrefix != null) {
            Predicate predicate = criteriaBuilder.like(tagEntityRoot.get(DaoConstants.FIELD_NAME),
